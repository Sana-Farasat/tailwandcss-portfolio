      ...
      <section>
          ...
          <div className="overflow-hidden">
            ...
            >
              <p className="p-1 text-sm">
                ...
                demonstrates my skills in programming logic, user interaction,
                and game design.
              </p>
              <Image
                src="/ngg.png"
          ...
          <div className="overflow-hidden">
            ...
            >
              <p className="p-1 text-sm">
                ...
                demonstrating my skills in application logic and user
                interaction.
              </p>
        ...
        <div className=" flex flex-col items-center sm:flex sm:flex-row justify-around mt-4 ">
          <div className="overflow-hidden">
            ...
            >
              <p className="p-1 text-sm">
                ...
                ability to implement mathematical logic and user interaction in
          ...
          <div className="overflow-hidden">
            ...
            >
              <p className="p-1 text-sm">
                The CLI Currency Converter is a command-line interface
                application that allows users to convert amounts between
                different currencies. This project highlights my skills in API
                integration, data handling, and user interaction in a console
                environment.
              </p>
