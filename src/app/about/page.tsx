  ...
  return (
    <main className="flex flex-col mt-12 mx-auto">
      ...
      <div className=" flex flex-col items-center sm:flex sm:flex-row justify-around mt-4 ">
        <div className="bg-green-200 shadow-lg h-auto max-w-sm mb-3 mx-2 flex justify-around p-auto rounded-lg text-green-950 transition-transform duration-75 scale-100 hover:scale-105 ease-in-out">
        ...
        <div className="bg-red-100 shadow-lg h-auto max-w-sm mb-3 mx-2  flex justify-around p-auto rounded-lg text-red-950 transition-transform duration-75 scale-100 hover:scale-105 ease-in-out">
          <p className="p-1 text-sm">
      ...
      <div className=" flex flex-col items-center sm:flex sm:flex-row justify-around mt-4 ">
        <div className="bg-gray-200 shadow-lg h-auto max-w-sm mb-3 mx-2 flex justify-around p-auto rounded-lg text-gray-950 transition-transform duration-75 scale-100 hover:scale-105 ease-in-out">
          <p className="p-1 text-sm">
        ...
        <div className="bg-yellow-200 shadow-lg h-auto max-w-sm mb-3 mx-2 flex justify-around p-auto rounded-lg text-yellow-950 transition-transform duration-75 scale-100 hover:scale-105 ease-in-out">
          <p className="p-1 text-sm">
      ...
      <div className="text-center text-3xl text-white mt-10 border border-gray-200 bg-yellow-100 transition-transform duration-75 scale-105 ease-in-out hover:bg-yellow-200">
        ...
        <div className="flex justify-center gap-10 my-3">
          <IoLogoHtml5 className="text-red-500 h-24 w-24 md:h-28 md:w-28" />
          <FaCss3Alt className="text-blue-500  h-24 w-24 md:h-28 md:w-28" />
        </div>
        <div className="flex justify-center gap-10 my-3">
          <IoLogoJavascript className="text-yellow-500  h-24 w-24 md:h-28 md:w-28" />

          <SiTypescript className="text-blue-500  h-24 w-24 md:h-28 md:w-28" />
        </div>
        <div className="flex justify-center gap-10 my-3">
          <FaReact className="text-pink-500  h-24 w-24 md:h-28 md:w-28" />
          <RiNextjsFill className="text-black  h-24 w-24 md:h-28 md:w-28" />
        </div>
      </div>
    </main>
  );
